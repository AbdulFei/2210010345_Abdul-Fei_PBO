...
//        jadwalList.add(new JadwalDokter(1, 1, "Dr. Abdulfei", "Spesialis Jantung", "Senin", "07:00-12:00", "fei", "2024-05-20", member1));
//        jadwalList.add(new JadwalDokter(2, 2, "Dr. Hanifs", "Spesialis Anak", "Selasa", "07:00-12:00", "hanif", "2024-05-21", member2));
//        jadwalList.add(new JadwalDokter(3, 3, "Dr. Ali", "Spesialis Jantung", "Rabu", "07:00-12:00", "ali", "2024-05-20", member3));
//        jadwalList.add(new JadwalDokter(4, 4, "Dr. Novals", "Spesialis Anak", "Kamis", "07:00-12:00", "noval", "2024-05-21", member4));
...
//        dbConnect.simpanMember("2", "Apotek", "Zulfikar", "Pelaihari", "083111212221", "paranormal.com");
          //dbConnect.ubahMember("1", "Apoteker", "Abdul Fei", "Kurau", "083150058587", "Feii.com");
...
//        dbConnect.simpanJadwal(2, "2", "Dr. Adul", "Dokter Mata", "Senin, Rabu, Kamis", "08:00 - 14:00", "adul", "WITA");
        //dbConnect.ubahJadwal("1", "Apoteker", "Abdul Fei", "Kurau", "083150058587", "Feii.com");
//        dbConnect.hapusJadwal("1", "", "", "");
//          dbConnect.cariJadwal("2");
//          dbConnect.showJadwal();

//        dbConnect.simpanLogin("adul", "admin", "2");
//        dbConnect.ubahLogin("fei1212", "admin", "1");
//        dbConnect.hapusLogin("fei", "", "");
//          dbConnect.cariLogin("2");
//          dbConnect.showLogin();

//          dbConnect.simpanRuang(2, "2", "Ruang Mawar", 2, "adul", "07:00-17:00");
        //  dbConnect.ubahRuang(1, "1", "Ruang PMI", 5, "fei", "07:00-17:00");
